...
global.roomCaptionDef = "I Wanna Be The YoYoYo Engine BetterBlock Edition";  //sets default window caption (only works with the Professional version of Studio)
...
global.startRoom = rBoshy1;    //sets which room to begin with
