...
global.roomCaptionDef = "I wanna Brainfuck";  //sets default window caption (only works with the Professional version of Studio)
...
global.startRoom = rmIntro;    //sets which room to begin with
